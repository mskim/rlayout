...
require File.dirname(__FILE__) + "/rlayout/base/document_base"
...
# require File.dirname(__FILE__) + "/rlayout/chapter/r_ordered_list"
...
# require File.dirname(__FILE__) + "/rlayout/book/style/r_chapter"
