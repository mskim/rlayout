...
NEWS_STYLES={
  ...
  "heading_columns" => [1,2,2,2,3,4,4],
  "title"   =>{:text_font => 'Times',     :text_size=>24.0, :text_color => 'black', :text_alignment=>'center',:text_line_spacing=>10 },
  "subtitle"=>{:text_font => 'Times',     :text_size=>16.0, :text_color => 'black'},
  "author"  =>{:text_font => 'Helvetica', :text_size=>10.0, :text_color => 'black', :text_alignment=>'center'},
  "lead"    =>{:text_font => 'Helvetica', :text_size=>18.0, :text_color => 'black', :text_alignment=>'right'},
  "Leading" =>{:text_font => 'Times',     :text_size=>18.0, :text_color => 'black'},
  "leading" =>{:text_font => 'Times',     :text_size=>18.0, :text_color => 'black'},
  "h1"      =>{:text_font => 'Helvetica', :text_size=>24.0, :text_color => 'black'},
  ...
  "h5"      =>{:text_font => 'Helvetica', :text_size=>12.0, :text_line_spacing=>5, :text_color => 'black'},
  "head"    =>{:text_font => 'Helvetica', :text_size=>12.0, :text_line_spacing=>5, :text_color => 'black'},
  "h6"      =>{:text_font => 'Helvetica', :text_size=>10.0, :text_line_spacing=>5, :text_color => 'black'},
  "p"       =>{:text_font => 'Times',     :text_size=>9.0, :text_line_spacing=>5, :text_alignment=>'justified', :text_color => 'black', :text_alignment=>'justified'},
