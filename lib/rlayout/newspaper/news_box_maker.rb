...
"quote"=>{"korean_name"=>"발문", "category"=>nil, "font_family"=>"KoPub바탕체_Pro Medium", "font"=>"KoPubBatangPM", "font_size"=>12.0, "text_color"=>"black", "alignment"=>"center", "tracking"=>-0.5, "space_width"=>6.0, "scale"=>100.0, "text_line_spacing"=>nil, "space_before_in_lines"=>2, "space_after_in_lines"=>nil, "text_height_in_lines"=>nil, "box_attributes"=>"", "markup"=>"", "dynamic_style"=>"", "publication_id"=>1},
