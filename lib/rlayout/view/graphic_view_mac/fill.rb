  ...
  def draw_fill(graphic)      
    ...
    if graphic.fill.class == RLayout::FillStruct
      ...
      unless fill_color.class == NSColor
        fill_color = convert_to_nscolor(fill_color)
      end    
      ...
      strating_color  = convert_to_nscolor(strating_color)    unless strating_color.class == NSColor  
      ending_color    = graphic.fill.ending_color
      ending_color    = convert_to_nscolor(ending_color)    unless ending_color.class == NSColor  
