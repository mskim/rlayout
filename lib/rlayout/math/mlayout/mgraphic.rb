...
module RLayout
  class MGFillRecord
    ...
    def fill_options
      ...
      fill_options[:fill_color]       = RLayout.color_from_string(@dictionary['CO1']) if @dictionary['CO1']
      fill_options[:fill_other_color] = RLayout.color_from_string(@dictionary['CO2']) if @dictionary['CO2']
      fill_options
    end
  ...
  class MGLineRecord
    ...
    def line_options
      ...
      line_options[:line_color]     = RLayout.color_from_string(@dictionary['LC']) if @dictionary['LC']
      line_options
