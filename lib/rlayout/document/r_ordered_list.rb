module RLayout
  ...
  # 
  #
  # ordering_char_types=  %w[1 a A] #[number, lower_alphabet, upper_alphabet, korean]
  # optional array can be passed with custom  
  # TODO this is adoc style do it for markdown as well
  
  
  # class OrderedList < Container
  class OrderedListLine < RLineFragement
    ...
    def initialize(options={})
      ...
      @ordering_char_types  = options.fetch(:ordering_char_types, %w[1 a A 가]
      parse_list_items
      self
    end
  ...
  class OrderedListPara < RParagraph
    attr_accessor :order, :level, :indent, :list_
  ...
  class UnorderedList < RLineFragement    
  ...
  class UnorderedListItem < RParagraph
