...
text_styles={
  ...
  "h5"      =>{:font => 'Helvetica', :text_size=>10.0, :text_color => 'black'},
  "head"    =>{:font => 'Helvetica', :text_size=>9.0, :text_color => 'black'},
  "h6"      =>{:font => 'Helvetica', :text_size=>9.0, :text_color => 'black'},
  "p"       =>{:font => 'Times', :text_size=>10.0, :text_line_spacing=>10, :text_alignment=>'left', :text_first_line_head_indent=>20},
  "Body"    =>{:font => 'Times', :text_size=>10.0, :text_line_spacing=>10, :text_alignment=>'left', :text_first_line_head_indent=>20},
  "body"    =>{:font => 'Times', :text_size=>10.0, :text_line_spacing=>10, :text_alignment=>'left', :text_first_line_head_indent=>20},
  "caption" =>{:font => 'Times', :text_size=>8.0, :text_color => 'black'},
  "header"  =>{:font => 'Times', :text_size=>8.0, :text_color => 'black'},
  "footer"  =>{:font => 'Times', :text_size=>8.0, :text_color => 'black'},
  "footer_page_number" =>{:font => 'Times', :text_size=>10.0, :text_color => 'black'},
}
