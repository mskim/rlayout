...
describe 'create YbPage even' do
  before do
    @page_path =  "#{ENV["HOME"]}/test_data/book/yearbook/yb_page_even"
    @pdf_path =  "#{ENV["HOME"]}/test_data/book/yearbook/yb_page_even/output.pdf"
...
describe 'create YbPage Odd' do
  before do
    @page_path =  "#{ENV["HOME"]}/test_data/yearbook/yb_page_odd"
    @pdf_path =  "#{ENV["HOME"]}/test_data/yearbook/yb_page_odd/output.pdf"
