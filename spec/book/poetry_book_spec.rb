...
describe 'test PoetryBook from md' do
  before do
    @project_path  = "#{ENV["HOME"]}/test_data/book/poetry_book_with_md"
...
#   before do
#     @project_path  = "#{ENV["HOME"]}/test_data/book/poetry_book"
#     # @pdf_path  = "#{ENV["HOME"]}/test_data/book/poetry_book/pdf/"
#     @poetry_book = PoetryBook.new(@project_path)
#   end
