...
#   before do
#     options = {:section_path=>"/Users/mskim/Development/rails4/newsman/public/issues/1/1", 
#       :page_info=>{:x=>0, :y=>0, :width=>1200, :height=>1600, :left_margin=>50, :top_margin=>50, :right_margin=>50, :bottom_margin=>50}, 
#       :heading_info=>{:x=>0, :y=>0, :width=>1200, :height=>133, :layout_length=>1, :image_path=>"/Users/mskim/Development/rails4/newsman/public/issues/1/1/section_heading.pdf"}, 
#       :main_info=>{:layout_length=>11}, 
#       :articles_info=>[{:x=>752.72, :y=>476.01, :width=>564.54, :height=>752.72, :image_path=>"/Users/mskim/Development/rails4/newsman/public/}/issues/1/1/1.pdf"}, 
