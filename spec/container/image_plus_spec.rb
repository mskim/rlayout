...
#     @pdf_path = "#{ENV["HOME"]}/test_data/image_plus/output.pdf"
#     @image_path = "#{ENV["HOME"]}/test_data/image_plus/소은숙.jpg"
#     @image_path = "#{ENV["HOME"]}/test_data/image_plus/강은숙.jpg"
...
describe 'testing ImagePlus ellipse' do
  before do
    # @image_items = %w[1.jpg 2.jpg]
    @image_path = "#{ENV["HOME"]}/test_data/image_plus/강은숙.jpg"
    @pdf_path = "#{ENV["HOME"]}/test_data/image_plus/output2.pdf"
    @ouput_path = "#{ENV["HOME"]}/test_data/image_plus/output2.pdf"
